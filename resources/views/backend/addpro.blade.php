                    ...
                    <div class="panel-body">
                        <div class=" form">
                            <form class="cmxform form-horizontal "
                             id="commentForm" method="post" action="{{route('ad.addpro')}}"
                            ...
                            @csrf
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="idbook" minlength="2" type="text" required="">
                                        </div>
                                    </div>

                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Name book</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="namebook" minlength="2" type="text" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="detailbook" minlength="2" type="text" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="description" minlength="2" type="text" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Price sale off</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="price_saleoff" minlength="2" type="text" required="">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            value="" minlength="2" type="text" required="">
                                        </div>
                                    </div>
                                    <div class="form-group ">
