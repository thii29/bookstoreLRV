                ...
                <section class="panel">
                    <div class="panel-body">
                        <div class=" form">
                            ...
                            id="commentForm" method="post" action="{{ route('ad.editcate') }}"
                           ...
                           @csrf
                                   ...
                                   <div class="form-group ">
                                       ...
                                       <div class="col-lg-6">
                                           <input class=" form-control" id="cname" value="{{$category->id}}" name="id"  
                                           minlength="2" type="text" readonly>
                                       </div>
                                   </div>
                                   ...
                                   <div class="form-group ">
                                       ...
                                       <div class="col-lg-6">
                                           <input class=" form-control" id="cname" value="{{$category->name}}" name="name"  
